              ...
              {chapterFaqs.map((faq, i) => (
                <Reveal key={faq.question} delay={i * 80}>
                  <details className="group border-t border-mist/15 py-6">
                    <summary className="flex cursor-pointer list-none items-start justify-between gap-6 font-serif text-xl transition-colors group-open:text-gold marker:hidden">
                      {faq.question}
                      <span
                        aria-hidden
